...
import googleChartData from '../../demoData/google-charts.json';

const {barChartData, materialDesignChart, comboChartData, lineChartData, MultilineChartData, pieChartData, bubbleChart} = googleChartData;
